...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class TriggerableGroupsMenuController : SimpleMenuManager 
	{
        ...
        [Tooltip("The index of the label you want to display for the triggerable module within its Labels list.")]
        [SerializeField]
        protected int triggerableModuleLabelIndex = 0;
		...
		void UpdateMenu()
		{
            ...
            for (int i = 0; i < triggerablesManager.mountedTriggerables.Count; ++i)
			{
                ...
                {
                    labelItems[i].SetLabel(module.Labels.Count > triggerableModuleLabelIndex ? module.Labels[triggerableModuleLabelIndex] : "");
                }
			}
